  ...
  <body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal">Let's Chat</h1>
        <p class="lead font-weight-normal">Chat with your friend without worrying about the chat logs. Now you can freely chat with your friend.</p>
        <form action="claim.php" method="post">
         Rooms:<input type="text" name="room">
         <br><br>
